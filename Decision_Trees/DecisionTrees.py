...
class Node:
    ...
    def __init__(
        ...
        Args:
            feature: The feature that this node splits on. Default is None.
            threshold: The threshold value for this node, Default is None.
            ...
            value: If this node is a leaf node, this attribute represents the predicted value
                    for the target variable. Default is None.
        """
...
class DecisionTree:
    ...
    def _best_split(self, X, y, feat_idxs):
        best_gain = -1
        split_inx, split_threshold = None, None
        ...
        return split_inx, split_threshold
    ...
    def _information_gain(self, y, X_column, threshold):
        ...
        Parameters:
            parent (np.ndarray): Input parent dataset.
